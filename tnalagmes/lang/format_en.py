...
from tnalagmes.util.time import get_timedelta, to_local

from datetime import datetime, timedelta
from tnalagmes.lang.format_common import convert_to_mixed_fraction
...
def nice_time_delta_en(time_delta, anchor=None):
    """
    ...
    if days < 0:
        ...
        return _future_time_delta_en(future, now)
